...
var _Vregular = _interopRequireDefault(__webpack_require__(/*! ./Vregular.js */ 12));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //正则验证
...
var Vrules = {
  ...
  num4: { pattern: _Vregular.default.num4, errMess: '请输入正确的4位数字' } };
...
var _vuex = _interopRequireDefault(__webpack_require__(/*! vuex */ 114));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var store = new _vuex.default.Store({
  ...
  mutations: {
    slogin: function slogin(state, session) {
      state.hasLogin = true,
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@vue/babel-preset-app/node_modules/@babel/runtime/regenerator */ 116));var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 2));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}
var vm = new _vue.default();

//执行登录操作，成功返回true，失败返回false
function doLogin(_x) {return _doLogin.apply(this, arguments);}
...
function _doLogin() {_doLogin = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(submitData) {return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:return _context.abrupt("return", new Promise(function (resolve, reject) {// uni.request({
              // 	url: vm.$baseURL,
              // 	method:'POST',
              // 	data:submitData,
              // 	success: (res) => {
              ...
              // 	}
              // })
              setTimeout(function () {console.log(submitData);try {uni.setStorageSync('token', 'login:ok');uni.setStorageSync('session', 'sessiontxt');vm.$store.commit('slogin', 'sessiontxt');resolve(true);} catch (e) {//TODO handle the exception
                  console.log(e);reject(false);}}, 500);}));case 1:case "end":return _context.stop();}}}, _callee);}));return _doLogin.apply(this, arguments);}function doLogout() {return _doLogout.apply(this, arguments);}function _doLogout() {_doLogout = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2() {return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:return _context2.abrupt("return", new Promise(function (resolve, reject) {try {uni.clearStorageSync();vm.$store.commit('slogout');resolve(true);} catch (e) {//TODO handle the exception
                console.log(e);reject(false);}}));case 1:case "end":return _context2.stop();}}}, _callee2);}));return _doLogout.apply(this, arguments);}
var loginapi = {
  doLogin: doLogin,
  doLogout: doLogout };
